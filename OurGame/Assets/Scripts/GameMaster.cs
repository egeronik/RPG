...
public class GameMaster : MonoBehaviour {
    ...
    void Update() {
        ...
        if (Target != null && k == 0 && Target.tag == "Player" && Input.GetMouseButtonDown(0) && !Target.GetComponent<Vrag>().died) {
            ...
            if (Target != TeamTarget[1] && TeamTarget[1] != null) {
                arrowTeamTarget2.SetActive(false);
            }
            if (Target == TeamTarget[1] && TeamTarget[1] != null) {
                arrowTeamTarget2.SetActive(true);
            }
            TeamTarget[0] = Target;
            arrowTeamTarget1 = TeamTarget[0].transform.Find("Arrow").gameObject;
            tmpTeamTarget = TeamTarget[0].transform.Find("Skills").gameObject;
        } else if (Target != null && k == 1 && Target.tag == "Player" && Input.GetMouseButtonDown(0) && !Target.GetComponent<Vrag>().died) {
            if (redArrowTarget != null) redArrowTarget.SetActive(false);
        ...
        if (Target != null && Target.tag == "Vrag" && Input.GetMouseButtonDown(0) && !Target.GetComponent<Vrag>().died) {
            if (k == 1) k--;
            if (redArrowTarget != null) redArrowTarget.SetActive(false);
            if (arrowTeamTarget2 != null && arrowTeamTarget1 != arrowTeamTarget2) arrowTeamTarget2.SetActive(false);
        ...
        if (CastSupport) {
            if (Target != null && Target.tag == "Player") {
                ...
                for (int i = 0; i < possibleSkillID.Length; i++) {
                    if (SkillID == possibleSkillID[i]) {
                        if (TeamTarget[1] == null || (Target != TeamTarget[1])) { 
                            TeamTarget[1] = TeamTarget[0];
                            if (k == 1) k--;
                        }
                        Skills[SkillID].Activate();
                        CastSupport = false;
       ...
       if (!turn) {
            ...
            tmpTeamTarget.SetActive(false);
            arrowTeamTarget1.SetActive(false);
